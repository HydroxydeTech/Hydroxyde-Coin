...
/** Utility functions used by the HDRX Qt UI.
 */
namespace GUIUtil
{
...
// Render HDRX addresses in monospace font
...
// Parse "hydroxyde:" URI into recipient object, return true on successful parsing
