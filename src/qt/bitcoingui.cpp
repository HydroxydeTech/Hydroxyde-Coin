...
QFontDatabase::addApplicationFont(":/fonts/hydroxyde_font");

QString windowTitle = tr("Hydroxyde Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HDRX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and HDRX: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hydroxyde Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hydroxyde Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HDRX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HDRX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HDRX addresses"));
    ...
    openAction->setStatusTip(tr("Open a HDRX: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Hydroxyde Core help message to get a list with possible HDRX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hydroxyde Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HDRX network", "", count));
}
...
{
    QString strTitle = tr("Hydroxyde Core"); // default title
