...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hydroxyde Core"),
     ...
     * override -datadir in the hydroxyde.conf file in the default data directory
     * (to be consistent with hydroxyded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
