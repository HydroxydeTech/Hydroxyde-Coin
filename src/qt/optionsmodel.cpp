...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::HDRX);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeUccAmount"))
        SoftSetArg("-anonymizehydroxydeamount", settings.value("nAnonymizeUccAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in hydroxyde.cpp during shotdown to also remove the window positions
