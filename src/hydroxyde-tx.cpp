...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hydroxyde Core hydroxyde-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hydroxyde-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded HDRX transaction") + "\n" +
                               "  hydroxyde-tx [options] -create [commands]   " + _("Create hex-encoded HDRX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded HDRX transaction
