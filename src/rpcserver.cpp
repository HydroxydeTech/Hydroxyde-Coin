...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HDRX features */
        {"hydroxyde", "masternode", &masternode, true, true, false},
        {"hydroxyde", "listmasternodes", &listmasternodes, true, true, false},
        {"hydroxyde", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hydroxyde", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hydroxyde", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hydroxyde", "masternodedebug", &masternodedebug, true, true, false},
        {"hydroxyde", "startmasternode", &startmasternode, true, true, false},
        {"hydroxyde", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hydroxyde", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hydroxyde", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hydroxyde", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hydroxyde", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hydroxyde", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hydroxyde", "mnsync", &mnsync, true, true, false},
        {"hydroxyde", "spork", &spork, true, true, false},
        {"hydroxyde", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hydroxyde", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hydroxyded, or the -server option to hydroxyde-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hydroxyde-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19314/\n";
}
