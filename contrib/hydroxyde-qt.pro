...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/hydroxyde-cli.cpp \
           src/hydroxyde-tx.cpp \
           src/hydroxyde.cpp \
           src/db.cpp \
           ...
           src/qt/hydroxyde.cpp \
           src/qt/hydroxydestrings.cpp \
...
RESOURCES += src/qt/hydroxyde.qrc src/qt/hydroxyde_locale.qrc

TRANSLATIONS += src/qt/locale/hydroxyde_bg.ts \
                src/qt/locale/hydroxyde_de.ts \
                src/qt/locale/hydroxyde_en.ts \
                src/qt/locale/hydroxyde_es.ts \
                src/qt/locale/hydroxyde_fi.ts \
                src/qt/locale/hydroxyde_fr.ts \
                src/qt/locale/hydroxyde_it.ts \
                src/qt/locale/hydroxyde_ja.ts \
                src/qt/locale/hydroxyde_pl.ts \
                src/qt/locale/hydroxyde_pt.ts \
                src/qt/locale/hydroxyde_ru.ts \
                src/qt/locale/hydroxyde_sk.ts \
                src/qt/locale/hydroxyde_sv.ts \
                src/qt/locale/hydroxyde_vi.ts \
                src/qt/locale/hydroxyde_zh_CN.ts \
                src/qt/locale/hydroxyde_zh_TW.ts
