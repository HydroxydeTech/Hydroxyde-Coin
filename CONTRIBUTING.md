Contributing to Hydroxyde Core
============================

The Hydroxyde Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hydroxyde Core project, and is not to be
confused with overall HDRX Network Protocol consensus changes.

Whether a pull request is merged into Hydroxyde Core rests with the project merge
...
Patches that change HDRX consensus rules are considerably more involved than
...
Where a patch set proposes to change the HDRX consensus, it must have been
...
The project leader is the release manager for each Hydroxyde Core release.
